...
class DatePickerViagemMobile extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _DatePickerViagemMobileState();
}

class _DatePickerViagemMobileState extends State<DatePickerViagemMobile> {
  ...
  @override
  void didUpdateWidget(covariant DatePickerViagemMobile oldWidget) {
...
class DatePickerController {
  _DatePickerViagemMobileState? _datePickerState;

  void _setDatePickerState(_DatePickerViagemMobileState state) {
