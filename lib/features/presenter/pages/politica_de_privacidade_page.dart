...
class PoliticaDePrivacidadePage extends StatefulWidget {
  @override
  _PoliticaDePrivacidadePageState createState() =>
      _PoliticaDePrivacidadePageState();
}

class _PoliticaDePrivacidadePageState extends State<PoliticaDePrivacidadePage> {
  double largura = 0.0;
              ...
              child: ConstrainedBox(
                ...
                child: IntrinsicHeight(
                  child: Column(
                    ...
                    children: [
                      buildHeader(),
                      buildWidgetPoliticaDePrivacidade(),
  ...
  Widget buildWidgetPoliticaDePrivacidade() {
    return Padding(
