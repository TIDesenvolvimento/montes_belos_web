...
class MeusDadosPageMobile extends StatefulWidget {
  @override
  _MeusDadosPageMobileState createState() => _MeusDadosPageMobileState();
}

class _MeusDadosPageMobileState extends State<MeusDadosPageMobile> {
  double largura = 0.0;
