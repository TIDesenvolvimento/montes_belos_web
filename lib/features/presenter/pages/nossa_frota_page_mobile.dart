...
class NossaFrotaPageMobile extends StatefulWidget {
  @override
  _NossaFrotaPageMobileState createState() => _NossaFrotaPageMobileState();
}

class _NossaFrotaPageMobileState extends State<NossaFrotaPageMobile> {
  double largura = 0.0;
  ...
  Widget buildAreaDeInformacao() {
    return Stack(
      ...
      children: [
        Column(
          children: [
            buildCabecalhoNossaFrota(),
            buildNossaFrotaAtualizada(),
          ],
        ),
      ],
    );
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(
                            espandirImagemNovaFrota ? Icons.remove : Icons.add,
                            color: Configuracao().COR_PRINCIPAL,
                          ),
                        ],
                      ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          clipBehavior: Clip
                              .antiAlias, // Garante que a imagem siga o arredondamento
                          child: Image.asset(
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Padding(
              padding: EdgeInsets.only(top: 0, left: 20, right: 20, bottom: 40),
              child: Column(
                children: [
                  GestureDetector(
                    onTap: () {
