...
class MinhasComprasPage extends StatefulWidget {
  @override
  _MinhasComprasPageState createState() => _MinhasComprasPageState();
}

class _MinhasComprasPageState extends State<MinhasComprasPage> {
  ...
  Container buildCabecalhoNossaFrota() {
    return Container(
      color: Colors.white,
          ...
          children: [
            MouseRegion(
              ...
              child: GestureDetector(
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                      left: largura > 1400 ? 315 : 115,
                      right: largura > 1400 ? 315 : 115,
                      bottom: 15),
                  child: Align(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(color: Configuracao().COR_PRINCIPAL),
                          ),
