...
class ResumoDeCompraPageMobile extends StatefulWidget {
  @override
  _ResumoDeCompraPageMobileState createState() =>
      _ResumoDeCompraPageMobileState();
}

class _ResumoDeCompraPageMobileState extends State<ResumoDeCompraPageMobile> {
  double largura = 0.0;
  ...
  var config = {
    'client_id': 'Client_Id_b717f10f75748227a42d35d5c5a96a9f8733ce98',
    'client_secret': 'Client_Secret_b09e13df23bc5d28fe4b7e39a7d43461e085b22a',
    'sandbox': false,
    'account_id': '9f213fc8fe806fd9d7c2c5babdd6b5d8'
  };
  late EfiPay efipay;
          ...
          child: Row(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(
                    'Total: ${getPrecoDaPassagem(valorTotal)}',
                    style: GoogleFonts.inter(
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                      color: Color.fromARGB(255, 0, 126, 180),
