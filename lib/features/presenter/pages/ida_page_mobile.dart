...
class IdaPageMobile extends StatefulWidget {
  late final PurchaseRequest? purchaseRequest;
  late String? dataIda = '';
  late String? dataVolta = '';
  IdaPageMobile({Key? key}) : super(key: key);

  @override
  _IdaPageMobileState createState() => _IdaPageMobileState();

  IdaPageMobile.fromArgs(dynamic arguments) {
...
class _IdaPageMobileState extends State<IdaPageMobile> {
  ...
  // Cabeçalho das Informações da Viagem
  ...
  buildCalendario() {
    return DatePickerViagemMobile(
      DateTime.parse(widget.dataIda!).subtract(Duration(days: 1)),
      locale: 'pt_BR',
  ...
  carregarPurchaseRequestIda() {
    ...
    purchaseRequest.totalTaxaEmbarqueForward =
