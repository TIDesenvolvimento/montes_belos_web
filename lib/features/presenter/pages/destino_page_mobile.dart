...
class _BuscaPageState extends State<DestinoPage> {
  final TextEditingController buscaController = TextEditingController();
  final FocusNode buscaFocusNode = FocusNode(); // Criar FocusNode
  ...
  void dispose() {
    ...
    buscaFocusNode.dispose(); // Limpar o FocusNode ao destruir a tela
    super.dispose();
  }
  ...
  void initState() {
    ...
    // Definir o foco no campo de texto assim que a tela for carregada
      ...
      child: Column(
        children: [
          TextFormField(
            ...
            focusNode: buscaFocusNode, // Associar o FocusNode ao campo
            onChanged: (value) {
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  onTap: () {
                    ...
                    PurchaseRequestStorage.salvarDestinoSelecionado(
                        agenciaSelecionada);
